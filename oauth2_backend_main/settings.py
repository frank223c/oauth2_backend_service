"""
Django settings for oauth2_backend_main project.
...
SECRET_KEY = ')=awq(%7c4w1hvjtkk9h=cdwmlbqv7ka)(v%06#!@uhab3*$(s'
...
AUTH_USER_MODEL = 'oauth2_backend.User'  # added
...
ROOT_URLCONF = 'oauth2_backend_main.urls'
...
WSGI_APPLICATION = 'oauth2_backend_main.wsgi.application'
...
CORS_ORIGIN_WHITELIST = ('127.0.0.1:9001', 'localhost:9002', 'localhost:9003')
